...
local expected_pane_mappings = {
    ...
    { key = "claude", modes = "n" },
    { key = "ipython", modes = "n" },
    { key = "toggle_terminal", modes = "n" },
    { key = "toggle_terminal_alt", modes = "n" },
    ...
    { key = "zoom", modes = "n" },
    { key = "ask_pane", modes = "n" },
    { key = "ask_submit", modes = { "n", "i" } },
    { key = "ask_send", modes = "n" },
    { key = "ask_send_alt", modes = "n" },
    { key = "ask_next_file", modes = "n" },
    { key = "ask_previous_file", modes = "n" },
    { key = "ask_next_selection", modes = "n" },
    { key = "ask_previous_selection", modes = "n" },
    { key = "ask_source", modes = "n" },
    { key = "ask_model_picker", modes = "n" },
    { key = "ask_model_picker_alt", modes = "n" },
    { key = "ask_last", modes = "x" },
    { key = "ask_codex", modes = "x" },
    { key = "ask_claude", modes = "x" },
}
